            ...
            <div class="col-lg-4">
                <div class="card card-body border-top-1 border-top-pink">
                    <div class="text-center">
                        ...
                        <button type="button" onclick="addProd()" class="btn btn-primary legitRipple"><i class="icon-plus-circle2 mr-2"></i>اضافه</button>
                    </div>
                </div>
            </div>
            <div class="col-md-12">
                        ...
                        <form action="{{url('dashboard/session/point/return')}}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" name="data_ion" id="data_ion" class="form-control" value="{{old('data_ion')}}"
                                           required>
                                    <span class="help-block">
                                     <strong class="data_ion-error text-danger"></strong>
                                    </span>
                                </div>
                                <div class="col-md-4">
                                    <label><span class="text-danger">*</span>اجمالي الفاتوره</label>
                                    <input type="number" name="in_total" min="1" step="any" id="in_total" class="form-control" value="{{old('in_total')}}"
                                           required>
                                    <span class="help-block">
                                     <strong class="in_total-error text-danger"></strong>
                                    </span>
                                </div>
                                </div>
                            <hr>
